...
import { getQuestion, trackContent } from "@/content";
  ...
  if (!run) {
    return (
      <div className="mx-auto max-w-2xl px-5 py-24 text-center sm:px-8">
        ...
        <ButtonLink href={href("/exam")} className="mt-6">
          До екзамену
        </ButtonLink>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-14 sm:px-8">
      ...
      <div className="mt-12 flex flex-wrap gap-3">
        <ButtonLink href={href("/train")} variant="primary">
          Опрацювати помилки
        </ButtonLink>
        <ButtonLink href={href("/exam")}>Спробувати ще раз</ButtonLink>
        <ButtonLink href={href("/stats")} variant="ghost">
          Профіль
        </ButtonLink>
      </div>
    </div>
